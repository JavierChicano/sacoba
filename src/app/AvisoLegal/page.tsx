      ...
      <section className="max-w-7xl w-full flex flex-col gap-8">
        <p>
          ...
          <h4>
            ...
            estos Términos y Condiciones de Uso, todas las leyes y regulaciones
            aplicables, y aceptas que eres responsable de cumplir con cualquier
            ley local aplicable. Si no estás de acuerdo con alguno de estos
            términos, tienes prohibido usar o acceder a este sitio.
          </h4>
        </p>
        <p>
          <h2 className="text-xl">2. Modificación de los Términos</h2>
          <h4>
            Sacoba se reserva el derecho de revisar y modificar estos Términos y
            Condiciones de Uso en cualquier momento sin previo aviso. Al
            utilizar este sitio web, aceptas estar sujeto a la versión actual de
            estos Términos y Condiciones de Uso.
          </h4>
        </p>
        <p>
          <h2 className="text-xl">3. Registro de Usuario</h2>
          <h4>
            Para realizar una compra en el sitio web de Sacoba, es obligatorio
        ...
        <p>
          <h2 className="text-xl">4. Privacidad</h2>
          <h4>
        ...
        <p>
          <h2 className="text-xl">6. Contenido del Usuario</h2>
          <h4>
        ...
        <p>
          <h2 className="text-xl">7. Propiedad Intelectual</h2>
          <h4>
        ...
        <p>
          <h2 className="text-xl">8. Limitación de Responsabilidad</h2>
          <h4>
        ...
        <p>
          <h2 className="text-xl">9. Enlaces a Sitios de Terceros</h2>
          <h4>
        ...
        <p>
          <h2 className="text-xl">10. Terminación del Acceso</h2>
          <h4>
        ...
        <p>
          <h2 className="text-xl">11. Legislación Aplicable</h2>
          <h4>
