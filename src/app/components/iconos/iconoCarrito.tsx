...
interface IconoCarritoProps extends SVGProps<SVGSVGElement> {
  size?: number;
  height?: number;
  width?: number;
...
export const IconoCarrito: FC<IconoCarritoProps> = ({
  size,
  height,
  width,
  color = "currentColor", // Color predeterminado
  ...props
}) => {
  return (
    <svg
      className="cursor-pointer"
      fill={color} // Utiliza el color proporcionado o el predeterminado
