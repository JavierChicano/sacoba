...
export default function DesplegableCarrito() {
  return (
    <aside className="bg-fondoSecundario absolute right-[8%] max-w-md w-full p-5 shadow-lg shadow-fondoSecundario z-50">
      ...
      <div className="bg-fondoTerciario flex justify-center items-center h-16 text-2xl cursor-pointer hover:bg-colorBase">Proceder al pago</div>
    </aside>
  );
}
