...
const baseUrl = "";
export const TemplatefacturaPedido = ({
  datos,
  idPedido,
  productos
}: {
  ...
  <Html>
    <Head />
    <Preview>Aqui tiene la factura de su pedido</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={track.container}>
          <Row>
            <Column>
              <Text style={global.paragraphWithBold}>Pedido ID</Text>
              <Text style={track.number}>{idPedido}</Text>
            </Column>
            <Column align="right">
              <Text style={global.marca}>SACOBA SL</Text>
            </Column>
          </Row>
        </Section>
        <Hr style={global.hr} />
        <Section style={message}>
          <Img
            ...
            alt="Logo Sacoba"
          />
          <Heading style={global.heading}>Está de camino.</Heading>
          <Text style={global.text}>
            Tu pedido está de camino, le iremos actulizando del progreso.
          </Text>
        </Section>
        <Hr style={global.hr} />
        <Section
...
export default TemplatefacturaPedido;
